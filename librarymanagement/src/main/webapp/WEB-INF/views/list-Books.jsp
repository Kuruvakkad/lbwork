		...
		<table class="table table-bordered table-striped">
			...
			<tbody>
				<c:forEach items="${Books}" var="tempBook">
					<tr>
						<td><c:out value="${tempBook.bookName}" /></td>
						<td><c:out value="${tempBook.category}" /></td>
						<td><c:out value="${tempBook.author}" /></td>
						
						<td>
							<!-- Add "update" button/link --> <a
							href="/LibraryManagement/books/showFormForUpdate?bookId=${tempBook.bookId}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/librarymanagement/books/delete?bookId=${tempBook.bookId}"
